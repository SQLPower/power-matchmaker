...
/**
 * This is the step that corrects the delivery installation name and type 
 * of an address. This is very similar but slightly different from the
 * {@link GeneralDeliveryNameAndTypeStep}.
 */
public class LockBoxNameAndTypeStep implements ValidateStep {
    
    private final AddressDatabase db;

    public LockBoxNameAndTypeStep(AddressDatabase db) {
        this.db = db;
    }
