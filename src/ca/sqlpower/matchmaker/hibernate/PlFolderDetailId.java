...
/**
 * PlFolderDetailId generated by hbm2java
 */
public class PlFolderDetailId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PlFolderDetailId) ) return false;
		 PlFolderDetailId castOther = ( PlFolderDetailId ) other; 
         
		 return ( (this.getFolderName()==castOther.getFolderName()) || ( this.getFolderName()!=null && castOther.getFolderName()!=null && this.getFolderName().equals(castOther.getFolderName()) ) )
