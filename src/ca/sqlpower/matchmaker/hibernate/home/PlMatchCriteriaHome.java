...
import ca.sqlpower.matchmaker.hibernate.PlMatchCriteriaId;
    ...
    public PlMatchCriteria findById( ca.sqlpower.matchmaker.hibernate.PlMatchCriteriaId id) {
        ...
        try {
            PlMatchCriteria instance = (PlMatchCriteria) getCurrentSession()
                    .get("ca.sqlpower.matchmaker.hibernate.PlMatchCriteria", id);
            if (instance==null) {
    ...
    public List findByExample(PlMatchCriteria instance) {
        ...
        try {
            List results = getCurrentSession()
                    .createCriteria("ca.sqlpower.matchmaker.hibernate.PlMatchCriteria")
