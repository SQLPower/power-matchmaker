 ...
 * @see ca.sqlpower.matchmaker.PlMatchWordCountTemp
 * @author Hibernate Tools
 */
public class PlMatchWordCountTempHome {
    ...
    public PlMatchWordCountTemp merge(PlMatchWordCountTemp detachedInstance) {
        ...
        try {
            PlMatchWordCountTemp result = (PlMatchWordCountTemp) sessionFactory.getCurrentSession()
    ...
    public PlMatchWordCountTemp findById( ca.sqlpower.matchmaker.PlMatchWordCountTempId id) {
        log.debug("getting PlMatchWordCountTemp instance with id: " + id);
        try {
            PlMatchWordCountTemp instance = (PlMatchWordCountTemp) sessionFactory.getCurrentSession()
                    .get("ca.sqlpower.matchmaker.generated.PlMatchWordCountTemp", id);
            if (instance==null) {
    ...
    public List findByExample(PlMatchWordCountTemp instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("ca.sqlpower.matchmaker.generated.PlMatchWordCountTemp")
