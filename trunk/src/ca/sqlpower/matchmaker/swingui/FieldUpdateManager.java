...
public class FieldUpdateManager {
	 ...
	 */
	private final SPListener propertyChangeListener = new AbstractSPListener() {
...
//				dep.applyChanges();
	...
	/**
	 * The text component that displays the data in the given SPObject at the given
	 * property name.
	 */
	...
	public FieldUpdateManager(JTextComponent textComp, 
			SPObject spo, 
		...
		handler.addValidateObject(textComp, new Validator() {
